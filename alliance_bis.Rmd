...
|------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 1    | Le / la détenu(e) refuse le cadre des entretiens cliniques. Il ne se présente pas aux entretiens ou s'y rend pour contester leur utilité ou critiquer le / la psychologue.                                                                                      |
| 2    | Le / la détenu(e) accepte de rencontrer le / la psychologue par obligation. Il répond aux questions de manière laconique et superficielle sans exprimer nécessairement son opposition de manière explicite.                                                                    |
| 3    | Le / la détenu(e) accepte volontiers de rencontrer le / la psychologue et répond aux questions de manière authentique. Il / elle semble lui faire confiance dans la réalisation de l'évaluation psychologique                                                          |
| 4    | Le / la détenu(e) se montre très investi(e) dans le processus d'évaluation, se montre demandeur / euse de rencontrer le / la psychologue, participe activement à la réflexion et évoque parfois combien les entretiens précédents l'ont amené(e) à changer son point de vue. |

### Selon vous, le / la détenu(e) tirerait-il / elle avantage d'une prise en charge psychologique ?
...
Le tableau taballiancepsy indique la fréquence des scores de qualité d'alliance thérapeutique des psychologues carcéraux pour chaque détenu(e) évalué(e).
...
Qu'en est-il du lien éventuel entre les scores O+A+C et le pertinence (ou non) d'une prise en charge thérapeutique aux yeux du / de la psychologue évaluatrice ? 
...
## Lien entre la personnalité du détenu et la qualité de l'alliance thérapeutique
...
Si nous comparons les scores de névrosisme pour ces deux groupes de détenus, nous constatons qu'ils sont significativement différents (*t* = `r ttestnalliancebinaireparameter`, *p* = `r ttestnalliancebinairepvalue`).

## Lien entre la personnalité du détenu et la pertinence d'une psychothérapie
...
kbl(tableNcor.df, caption = "Corrélations de spearman entre les facettes de névrosisme et l'alliance thérapeutique évaluée par les psychologues carcéraux", booktabs = T) 
```
...
kbl(tableEcor.df, caption = "Corrélations de spearman entre les facettes de névrosisme et l'alliance thérapeutique évaluée par les psychologues carcéraux", booktabs = T) 
```
...
kbl(tableOcor.df, caption = "Corrélations de spearman entre les facettes de névrosisme et l'alliance thérapeutique évaluée par les psychologues carcéraux", booktabs = T) 
```
...
kbl(tableAcor.df, caption = "Corrélations de spearman entre les facettes de névrosisme et l'alliance thérapeutique évaluée par les psychologues carcéraux", booktabs = T) 
```
...
kbl(tableCcor.df, caption = "Corrélations de spearman entre les facettes de névrosisme et l'alliance thérapeutique évaluée par les psychologues carcéraux", booktabs = T) 
```
